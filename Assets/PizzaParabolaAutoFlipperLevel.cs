...
public class PizzaParabolaAutoFlipperLevel : MonoBehaviour
{
    private int Level;
    ...
    void StopRotation()
    {
        GetComponent<PizzaRotationAutoFlipper>().StopRotate = 1;
    }

    void ResumeRotation()
    {
        GetComponent<PizzaRotationAutoFlipper>().StopRotate = 0;
    }
    ...
    void Update()
    {
        ...
        if (GlobalData.KeyDown == true && GlobalData.KeyHold == true && GlobalData.KeyUp == false && IsThrowing == 0)
        {
